 ...
 * endpoint with a single curl command, so everything is checked here
...
/**
 * @returns {{ data: object, errors: Record<string,string>, ok: boolean }}
 */
function validateEnquiry(body = {}) {
  ...
  // The email is required because the confirmation copy is part of what the
  // form promises. Without an address there is nothing to confirm to.
  if (!data.email) errors.email = 'We need your email to send you a copy of your request.';
 ...
 * and every value in these emails came from a stranger on the internet.
 */
 ...
 * a subject line is how header-injection attacks start — someone puts
 * "\r\nBcc: everyone@example.com" in their name and we relay their spam.
 */
